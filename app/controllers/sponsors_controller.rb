class SponsorsController < ApplicationController
  ...
  private
    ...
    def sponsor_params
      params.require(:sponsor).permit(:first_name,:email,  :last_name, :phone, :address, :country_of_residence, :reason_of_sponsorship, :type_of_sponsorship_offering, :feedback)
    end
end

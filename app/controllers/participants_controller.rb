class ParticipantsController < ApplicationController
  ...
  private
    ...
    def participant_params
      params.require(:participant).permit(:first_name, :last_name, :address, :proffession, :investment_idea, :impact_of_idea, :sector_of_investment, :proffessional_experience, :summary_of_project, :province_of_interest)
    end
end

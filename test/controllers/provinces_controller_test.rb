...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference("Province.count") do
      post provinces_url, params: { province: { chef_lieu: @province.chef_lieu, langues: @province.langues, map: @province.map, name: @province.name, superficie: @province.superficie, territoires: @province.territoires } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { chef_lieu: @province.chef_lieu, langues: @province.langues, map: @province.map, name: @province.name, superficie: @province.superficie, territoires: @province.territoires } }
